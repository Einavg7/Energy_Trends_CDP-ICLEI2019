...
![](Energy_Trends_files/figure-docx/8.0a scale-1.png) 
...
![](Energy_Trends_files/figure-docx/8.0a column2-1.png)
![](Energy_Trends_files/figure-docx/8.0a column2-2.png) 
...
![](Energy_Trends_files/figure-docx/target and base year-1.png)
![](Energy_Trends_files/figure-docx/target and base year-2.png)
...
![](Energy_Trends_files/figure-docx/renewable energy in base year-1.png)
...
![](Energy_Trends_files/figure-docx/renewable energy in base year2-1.png)
...
![](Energy_Trends_files/figure-docx/renewable energy in target year-1.png) 

Plot 8 consist of boxplots that summarize the distribution of the renewable energy and electricity in $MWh$ covered by target in base year for each CDP Region. The boxplots are displayed using the log 10 transformation to stabilize the variation within CDP Regions.The organizations within the CDP Regions present a wide distribution with some organizations setting very high renewable energy / electricity targets and others low renewable energy / electricity targets.(n=the number of targets)

![](Energy_Trends_files/figure-docx/renewable energy in target year2-1.png) 
...
![](Energy_Trends_files/figure-docx/renewable energy percentage regions-1.png) 
...
![](Energy_Trends_files/figure-docx/renewable energy percentage regions target-1.png) 
...
![](Energy_Trends_files/figure-docx/why no targt 8b-1.png) 
...
![](Energy_Trends_files/figure-docx/mix o electricity 8.1-1.png) 
...
![](Energy_Trends_files/figure-docx/what scale is 8.1 (8.2)-1.png) 
...
![](Energy_Trends_files/figure-docx/q85-1.png)
...
![](Energy_Trends_files/figure-docx/q86-1.png) 
...
![](Energy_Trends_files/figure-docx/8.6a scale-1.png) 
...
![](Energy_Trends_files/figure-docx/Energy efficiency type covered by target-1.png)

![](Energy_Trends_files/figure-docx/Energy efficiency type covered by target-2.png) 
...
![](Energy_Trends_files/figure-docx/target and base year ee -1.png)

![](Energy_Trends_files/figure-docx/target and base year ee -2.png) 
...
![](Energy_Trends_files/figure-docx/energy consumed/produced covered in base year-1.png) 
...
![](Energy_Trends_files/figure-docx/energy consumed/produced covered in target year-1.png) 
